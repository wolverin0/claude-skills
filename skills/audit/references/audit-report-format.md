...
PASS: No hard stops detected. The codebase has no H1-H9 conditions present.

[Otherwise:]

WARN:️  <count> hard-stop conditions detected. DO NOT LAUNCH UNTIL RESOLVED.
...
Skills invoked (in order):
  ...
  5. audit-domain-01-security through audit-domain-13-code-integrity
     (13 domain skills, run as isolated domain passes)
  6. audit-fix-generator     - invoked per finding for AI fix prompts

Each domain ran as its own isolated audit pass, returning a
