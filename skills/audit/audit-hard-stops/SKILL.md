...
1. Run the detection commands documented in
   `../references/audit-hard-stops.md`
2. Read the output
...
```
view ../references/audit-rules.md       # R1-R7
view ../references/audit-hard-stops.md  # H1-H9 detection details
```
...
- FAIL: Marking H<N> as NOT FOUND without showing the detection commands run
- FAIL: Marking H<N> as FOUND from grep alone without reading the actual code
- FAIL: Softening any FOUND finding ("technically yes but probably fine")
- FAIL: Mixing hard-stop findings into other domains' sections - they
  belong in this report
- FAIL: Producing fewer than 9 entries (one per H-class) - even if NOT
