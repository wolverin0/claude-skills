...
**Load [PASS: Evaluation Guide](./references/evaluation.md) for complete evaluation guidelines.**
...
- [PASS: Evaluation Guide](./references/evaluation.md) - Complete evaluation creation guide with:
